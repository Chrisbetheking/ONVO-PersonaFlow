...
export type HealthResponse = {
  ...
  public_demo_quota?: {
    ...
    calls_per_workspace_day: number;
    global_daily_budget: number;
...
export type ConnectionMode = "live" | "stale_online" | "local_demo";
...
export type CustomerStateEvidence = {
  text: string;
  source: string;
  occurred_at: string;
  channel: string;
  method: "规则" | "模型" | "人工" | string;
  demo_flag: boolean;
};
export type CustomerStateDimension = {
  level: string;
  evidence: Array<string | CustomerStateEvidence>;
};
